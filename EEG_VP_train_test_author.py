...
sub_list = get_files_names_in_directory("/content/drive/MyDrive/EEG2Video_data/processed/EEG_DE_1per1s_authors/")

All_sub_top1 = []
All_sub_top5 = []

for subname in sub_list:
    load_npy = np.load("/content/drive/MyDrive/EEG2Video_data/processed/EEG_DE_1per1s_authors/" + subname)
