...
#     "subset_D": [0, 3, 7, 9, 11, 22, 25, 26, 27, 39],
#     "subset_E": [1, 2, 4, 6, 8, 12, 21, 24, 28, 36],
#     "subset_F": [3, 5, 7, 10, 11, 13, 22, 26, 30, 38],
#     "subset_G": [0, 4, 6, 8, 9, 12, 21, 23, 27, 37],
#     "subset_H": [1, 2, 5, 7, 10, 11, 22, 24, 28, 39],
#     "subset_I": [3, 4, 6, 8, 12, 13, 21, 25, 29, 36],
#     "subset_J": [0, 2, 5, 7, 9, 10, 22, 23, 27, 38],
# }

SUBSETS = {
    "subset_A": [11, 0, 21, 10, 5],
    "subset_B": [36, 23, 27, 30, 26],
    "subset_C": [4, 1, 13, 12, 7],
    "subset_D": [26, 22, 24, 38, 28],
    "subset_E": [2, 6, 8, 5, 10],
    "subset_F": [21, 29, 23, 37, 30],
    "subset_G": [9, 0, 7, 3, 11],
    "subset_H": [39, 22, 27, 26, 25],
    "subset_I": [1, 2, 4, 6, 8],
    "subset_J": [24, 28, 36, 21, 12],
    "subset_K": [7, 10, 11, 3, 5],
    "subset_L": [30, 22, 38, 26, 13],
    "subset_M": [4, 9, 6, 8, 0],
    "subset_N": [21, 23, 27, 12, 37],
    "subset_O": [10, 1, 7, 2, 5],
    "subset_P": [22, 39, 28, 11, 24],
    "subset_Q": [12, 36, 3, 6, 4],
    "subset_R": [13, 25, 38, 29, 21],
    "subset_S": [9, 2, 7, 0, 5],
    "subset_T": [27, 30, 22, 10, 23],
}
